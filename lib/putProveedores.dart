...
Future<Proveed> editProveedor(String nombreProveedor, String nit, String emailProv, String telefonoProv, String categoriaProv, String estadoProv ) async {
  ...
  Scaffold buildColumn() {
    ...
    const SizedBox(height: 16),
        ElevatedButton(
          onPressed: () {
            setState(() {
              _futureProveed = editProveedor(_nombreProveedor.text, _nit.text, _emailProv.text, _telefonoProv.text, _categoriaProv.text, _estadoProv.text);
            });
                      },
